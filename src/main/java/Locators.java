...
public class Locators {
    ...
    public static final By AD_MARK = By.id("bx-close-inside-2347228");
    public static final By LINK_TO_MEN_PAGE = By.xpath("//a[@data-text='Men']");
    ...
    public static final By SEARCH_BUTTON_FOR_ZIPCODE = By.className("btn-search");
